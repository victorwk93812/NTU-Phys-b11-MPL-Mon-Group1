...
for ax in axsFFT:
    ...
    ax.plot(FFT_freq[i][FFT_peaks[i]], FFT_sig[i][FFT_peaks[i]], "or", label = "Peaks")
    ...
    ax.plot(FFT_freq[i][FFT_peaks[i][idx]], FFT_sig[i][FFT_peaks[i][idx]], "^g", label = "Precession Signal")
...
figT2star, axsT2star = plt.subplots(3, figsize = (10, 5))
